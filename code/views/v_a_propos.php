...
<div class="container_page">
    ...
    <div class="champ" id="presentation">
        ...
        <p class="text">
        "Trouve ton plat" est un projet réalisé par quatre étudiants dans le cadre d'un projet (situation d'apprentissage et d'évaluation) en BUT Informatique. Il comprend un site internet (sur lequel vous vous trouvez actuellement), mais également une application gérant l'administration du site (ajout de plats, gestion des événements, gestion des utilisateurs, etc.). <br /><br />
            
        Le site consiste a pour objectif la recherche de recettes de plats en fonction des ingrédients que vous possédez. Ces plats sont partagés par les utilisateurs, il est donc possible de partager vous-même des plats en créant un compte et en soumettant une proposition de plat qui sera ensuite validée par un administrateur. <br /><br />
        </p>
    </div>
...
Le site web est développé en HTML, CSS et JavaScript pour l'aspect visuel, et en PHP pour la relation entre la base de données et le site. L'application de gestion est quant à elle développée en Java, utilisant le framework JDBC pour permettre la relation entre l'application et la base de données. Pour ce qui est de la base de données, les informations sont stockées dans une base MySQL et est hébergée dans les serveurs d'Alwaysdata, hébergeant également le site.<br /><br />
    ...
    <div class="champ" id="technologies">
        ...
        <p class="text">
            Nous sommes tous les 4 étudiants en BUT Informatique à Villeurbanne, et c'est avec la présence de notre tuteur de projet que nous avons pu réaliser ce projet et vous le présenter.<br /><br /> 
        </p>
